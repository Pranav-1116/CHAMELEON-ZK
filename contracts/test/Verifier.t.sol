...
contract VerifierTest is Test {
    ...
    function testValidTransitionTracking() public {
        ...
        // Before verification
        assertFalse(morph.isValidTransition(0, 1, oldCommit, newCommit), "Should not be valid before verification");
        ...
        // After verification
        assertTrue(morph.isValidTransition(0, 1, oldCommit, newCommit), "Should be valid after verification");
    }
}
